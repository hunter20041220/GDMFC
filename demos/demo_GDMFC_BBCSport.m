...
layers = [200, 100];  % hidden layer dimensions: 200 -> 100 -> 5
...
options.lambda2 = 0.001;     % co-orthogonal constraint coefficient 协正交约束系数
options.beta = 300;          % graph regularization coefficient 图正则化系数
